package com.example.android.userlogin;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Fikri RJ");
    ...
    public void loginMasuk(View view) {
        ...
        if ((text1.contains("Username"))&&((text2.contains("Password")))) {
            ...
            Intent intent = new Intent(MainActivity.this, com.example.android.userlogin.SecondActivity.class);
